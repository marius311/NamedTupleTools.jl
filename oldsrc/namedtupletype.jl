...
ntt(names::NTuple{N,Symbol}, types::NTuple{N,<:DataType}) where {N} = NamedTuple{names, Tuple{types...}} 
ntt(names::NTuple{N,AbstractString}, types::NTuple{N,<:DataType}) where {N} = ntt(Symbol.(names), types)

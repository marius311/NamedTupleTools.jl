...
prototype(@nospecialize names::Symbol, @nospecialize types::Tuple{T}) where {T<:DataType} = NamedTuple{(names,), Tuple{T}}
#prototype(names::Tuple{Symbol}, types::Type) = NamedTupleP{names, Tuple{types}}
